...
class GestionRequest(http.Controller):
   ...
   # Levantamiento de vistas qweb
    ...
    def guardar_pdf_requerimiento(self, **post):
        ...
        importe_s_char= "Por la Suma de :    ..." + post['importe_s_char']
        ...
        "importe_s":importe_s,"importe_s_char":importe_s_char,"importe_uss":importe_uss,"importe_cheque":importe_cheque,"fecha_solicitud":fecha_solicitud,"numeros_requerimiento_text":numeros_requerimiento_text,
    ...
    def guardar_pdf_gastos(self, **post):
        ...
        "fecha_importe5":fecha_importe5,"importe_total_fecha5":importe_total_fecha5})[0]
