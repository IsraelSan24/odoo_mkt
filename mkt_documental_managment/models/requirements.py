...
class DocumentalRequirements(models.Model):
    ...
    def settlement_petitioner_sign(self):
        ...
        if self.unify:
            ...
            self.requirement_state = 'external_control' if ((self.budget_id.sudo().partner_brand_id.for_province == True) and (self.create_uid.partner_id.is_province == True)) or ((self.budget_id.sudo().partner_brand_id.for_capital == True) and (self.create_uid.partner_id.is_province == False)) else 'executive'
        else:
            self.settlement_attach_files()
        ...
        self.write({
            ...
            'settlement_state': 'external_control' if ((self.budget_id.sudo().partner_brand_id.for_province == True) and (self.create_uid.partner_id.is_province == True)) or ((self.budget_id.sudo().partner_brand_id.for_capital == True) and (self.create_uid.partner_id.is_province == False)) else 'executive'
        })
        self.blacklist_validation()
